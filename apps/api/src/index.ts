...
import adminStructureRoutes from './routes/admin-structure.routes'; // ← NOUVEAU
import pharmacienRoutes     from './routes/pharmacien.routes';      // ← NOUVEAU
...
app.use('/api/v1/admin-structure', adminStructureRoutes); // ← NOUVEAU
